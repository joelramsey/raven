...
import { DendrogramDatum } from './dendrogram-datum.interface';

@Component({
  selector: 'rvn-dendrogram',
  templateUrl: './dendrogram.component.html',
  styleUrls: ['./dendrogram.component.scss']
})
export class DendrogramComponent implements OnInit, OnChanges {

  @Input() data:DendrogramDatum;
  ...
  private _render() {
    ...
    function update(source) {
      ...
      nodes.forEach(function(d:any) { d.y = d.depth * 300; });
