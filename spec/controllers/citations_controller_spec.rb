...
RSpec.describe CitationsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested citation as @citation" do
      citation = Citation.create! valid_attributes
      get :show, params: {id: citation.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested citation as @citation" do
      citation = Citation.create! valid_attributes
      get :edit, params: {id: citation.to_param}, session: valid_session
      expect(assigns(:citation)).to eq(citation)
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved citation as @citation" do
        post :create, params: {citation: invalid_attributes}, session: valid_session
        expect(assigns(:citation)).to be_a_new(Citation)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested citation" do
        citation = Citation.create! valid_attributes
        put :update, params: {id: citation.to_param, citation: new_attributes}, session: valid_session
        citation.reload
    ...
    context "with invalid params" do
      it "assigns the citation as @citation" do
        citation = Citation.create! valid_attributes
        put :update, params: {id: citation.to_param, citation: invalid_attributes}, session: valid_session
        expect(assigns(:citation)).to eq(citation)
      end
